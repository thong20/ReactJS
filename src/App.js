...
function App() {
  useEffect(() => {
    ...
    const appearOptions = {
      ...
      // threshold có giá trị từ 0 đến 1 (0% -> 100%)
      // tương ứng với top đến bottom của
      // đối tượng fade-in
      // top:
      // threshold: 0,
      ...
      (entries, appearOnScroll) => {
        ...
        entries.forEach((entry) => {
          if (!entry.isIntersecting) {
            // entry có nằm trong vùng viewport không?
            return;
          } else {
  ...
  return (
    <div className="App">
      ...
      <div className="border-line-rootMargin"></div>
      <div className="rootMargin">
        <p>rootMargin height: 200px</p>
      </div>
      <div className="columns">
        <div className="border-line-threshold"></div>
        <div className="col fade-in">
          <h3>Lorem ipsum</h3>
          <p>
            Lorem Ipsum is simply dummy sjflkdjs pajlsdjf la text of the
        ...
        <div className="article">
          <div className="img">
            <div className="avatar">
              <div className="border-line-threshold-img"></div>
          ...
          <div className="text from-right slide-in">
            ...
            <p>
              ...
              is simply dummy sjflkdjs pajlsdjf la text of the printing and
